...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            if (isset($_POST['sectiontypeedit_btn'])) {
                $id = $_POST['edit_id'];
                $query = "SELECT * FROM sectiontype WHERE id ='$id' ";
            ...
            <button type="submit" name="updatesectiontypebtn" class="btn btn-success "> Update </button>
                    </form>
            <?php
                }
            }
