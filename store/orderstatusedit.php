...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-success"> EDIT Order Status</h6>
        </div>
        <div class="card-body">
            <?php
            $connection = mysqli_connect("localhost", "root", "", "store");
            if (isset($_POST['orderstatusedit_btn'])) {
                $id = $_POST['edit_id'];
            ...
            ?>
                    ...
                    <a href="orderstatus.php" class="btn btn-danger">CANCEL</a>
            <button type="submit" name="updateorderstatusbtn" class="btn btn-success "> Update </button>
                    </form>
            <?php
                }
            }
