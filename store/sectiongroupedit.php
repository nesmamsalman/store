...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-success"> EDIT Section Group</h6>
        </div>
        <div class="card-body">
            <?php
            $connection = mysqli_connect("localhost", "root", "", "store");
            if (isset($_POST['sectiongroupedit_btn'])) {
                $id = $_POST['edit_id'];
                $query = "SELECT * FROM sectiongroup WHERE id ='$id' ";
            ...
            ?>
                    ...
                    <a href="sectiontype.php" class="btn btn-danger">CANCEL</a>
                  <button type="submit" name="updatesectiongroupbtn" class="btn btn-success "> Update </button>
                    </form>
            <?php
                }
            }
